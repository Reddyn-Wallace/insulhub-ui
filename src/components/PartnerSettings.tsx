...
export default function PartnerSettings() {
  ...
  return <div className="grid gap-6"><SubmissionNotificationSettings/><PartnerOpsCompanies companies={companies}/></div>;
}
...
function SubmissionNotificationSettings(){
  ...
  return <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5"><h2 className="text-xl font-bold text-[#1a3a4a]">Submission notifications</h2><p className="mt-1 text-sm text-slate-600">A notification is sent here after a partner job has been successfully created in InsulHub.</p>
