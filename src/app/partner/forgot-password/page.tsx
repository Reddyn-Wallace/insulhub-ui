...
export const metadata: Metadata = { title: "Reset your password | InsulHub", robots: { index: false, follow: false }, referrer: "no-referrer" };
  ...
  return <main id="main-content" className="partner-portal flex min-h-screen flex-col bg-gray-50">
    ...
    <div className="flex flex-1 items-center justify-center px-4 py-10">
      <section className="w-full max-w-md rounded-2xl border border-gray-100 bg-white p-6 shadow-md sm:p-8" aria-labelledby="partner-access-heading">
        ...
        <h1 id="partner-access-heading" className="mt-1 text-2xl font-bold text-[#1a3a4a]">Reset your password</h1>
        <p className="mt-2 text-sm leading-6 text-gray-600">Enter your partner account email address.</p>
        <div className="mt-6"><PartnerForgotPasswordForm /></div>
      </section>
    </div>
  </main>;
}
